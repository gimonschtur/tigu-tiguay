...
| UX-M07 | Must     | The system shall display a persistent pane on all screens containing: (a) access to the home screen, (b) access to each round, category, and question, (c) a summary of each team's running total score, and (d) access to the score deduction screen (UX-M09). |
